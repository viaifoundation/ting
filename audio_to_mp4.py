...
if "-?" in sys.argv:
    ...
    print("  --caption-scale SCALE        Caption font scale: 1x, 2x, 3x, 4x, etc. (Default: 1x)")
    ...
    print(f"  python {sys.argv[0]} output/devotion.mp3 --caption true  # Standard 1x captions")
    print(f"  python {sys.argv[0]} output/devotion.mp3 --caption true --caption-scale 2x  # 2x font")
    print(f"  python {sys.argv[0]} output/devotion.mp3 --caption true --caption-scale 3x  # 3x font")
...
def create_mp4(input_mp3: str, bg_image: str = None, output_mp4: str = None, 
    ...
    Args:
        ...
        caption_scale: Caption font scale multiplier: '1x', '2x', '3x', '4x', etc. (default: '1x')
