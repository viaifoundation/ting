...
if "-?" in sys.argv:
    ...
    print(f"  python {sys.argv[0]} output/devotion.mp3 --caption true --caption-large  # 3x larger captions")
...
def create_mp4(input_mp3: str, bg_image: str = None, output_mp4: str = None, 
    ...
    Args:
        ...
        caption_large: Whether to render caption font 3x larger (default: False)
    ...
    if caption:
        ...
        if srt_file and os.path.exists(srt_file):
            ...
            if cues:
                mode_label = " [3x Large Font]" if caption_large else ""
                print(f"🎬 Creating Hardsub MP4 (Burned-in Captions{mode_label})...")
                print(f"   Input audio: {input_mp3}")
                print(f"   Background:  {bg_image}")
                print(f"   Output:      {output_mp4}")
                print(f"   Resolution:  {resolution}")
                print(f"   Captions:    {srt_file} ({len(cues)} cues, Burned-in{mode_label})")
                if metadata:
...
def batch_convert(folder: str, bg_image: str, resolution: str, bitrate: str,
                  ...
                  caption: bool = False, caption_file: str = None,
