#!/usr/bin/env python3
"""
Generate New Testament 40-day reading plan audio.

Input is a day number (1–40) or a range (e.g. 1-5, 16-17).
Produces one file per day at 1.5x speed with background music.
Filename format: 40天新約挑戰第01天_馬可1-4.mp3
...
Usage:
  python scripts/nt40.py 1
  python scripts/nt40.py 1-5
  python scripts/nt40.py --compare False               # disable comparison
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate New Testament 40-day plan audio (1.5x + BGM)",
        epilog="""
Examples:
  python scripts/nt40.py 1
  python scripts/nt40.py 1-5
""",
    ...
    parser.add_argument(
        "days",
        type=str,
        help="Day number (1–40) or range (e.g. 1-5, 16-17)",
    )
    parser.add_argument(
        "-o", "--output",
        type=str,
        default=None,
        help="Output directory (default: audio/nt-40days/)",
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(used with --compare). Supported: cuvs (CUV Simplified, default), "
