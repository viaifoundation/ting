...
With --use-chapter-filename (default here), stems are descriptive:
{N}天智慧讚美對照第{dd}天-… for male_then_female,
{N}天智慧讚美第{dd}天-… for rotate / single-voice; see generate_plan_audio.py.
